        ...
        container.innerHTML = `
            <div class="nav-bar">
                ...
                <div style="display:flex;gap:4px">
                    <button class="nav-btn" id="btn-export" aria-label="Export CSV" title="Export">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12"/><path d="m8 11 4 4 4-4"/><rect x="3" y="17" width="18" height="4" rx="1"/></svg>
                    </button>
                    <button class="nav-btn" id="btn-import" aria-label="Import CSV" title="Import">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 15V3"/><path d="m16 7-4-4-4 4"/><rect x="3" y="17" width="18" height="4" rx="1"/></svg>
                    </button>
